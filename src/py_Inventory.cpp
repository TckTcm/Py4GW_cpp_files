...
void bind_Inventory(py::module_& m) {
    py::class_<Inventory>(m, "PyInventory")
        ...
        .def("ApplyUpgrade", &Inventory::ApplyUpgrade, py::arg("inventory_id"), py::arg("target_item_id"), py::arg("upgrade_item_id"), py::arg("upgrade_slot") = -1, py::arg("target_agent_id") = 0)
