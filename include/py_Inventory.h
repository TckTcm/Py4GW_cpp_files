...
public:
    ...
    bool ApplyUpgrade(int inventory_id, int target_item_id, int upgrade_item_id, int upgrade_slot = -1, int target_agent_id = 0) {
        ...
        const uint32_t target_agent_id_u32 = static_cast<uint32_t>(target_agent_id);
        ...
        if (!(target_inventory_id && target_item_id_u32 && upgrade_item_id_u32 && target_agent_id_u32))
            return false;
